      ...
      <div className="form-container container-form-briefing">
        <form action="https://formsubmit.co/open.solucoes@outlook.com" className="contact-form" method="POST">
          <div className="form-briefing">
            ...
            <textarea required name="Nos informe as abas que deseja no site e os dados importantes para conterem em cada uma delas. Exemplo: Aba: Especialidades | Descrição: Otorrinolaringologia, Fonoaudiologia, etc." className="place-text areaBriefing" id="nomeDaMarca"></textarea>
          </div>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="Nos informe os dados de contato que devam constar no site, como telefones, whatsapp, endereços, redes sociais, etc." className="place-text areaBriefing" id="referencia"></textarea>
          </div>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="No campo de formulário de agendamento de consultas, quais campos você deseja que o paciente preencha? Exemplo: Nome completo, WhatsApp, motivo da consulta, etc." className="place-text areaBriefing" id="elemento"></textarea>
          </div>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="Nos informe um e-mail para onde serão direcionados os formulários de agendamento dos seus pacientes. Toda solicitação de agendamento chegará no e-mail informado. 
" className="place-text areaBriefing" id="cores"></textarea>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="Há algum site de referência que você goste? Há alguma preferência no layout que você deseje nos informar?" className="place-text areaBriefing" id="adjetivos"></textarea>
          </div>
