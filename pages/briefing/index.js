      ...
      <div className="form-container container-form-briefing">
        <form action="https://formsubmit.co/open.solucoes@outlook.com" className="contact-form" method="POST">
          <div className="form-briefing">
            ...
            <textarea required name="Qual nome será usado na marca? Haverá slogan?" className="place-text areaBriefing" id="nomeDaMarca"></textarea>
          </div>

          <div className="form-briefing">
            <label htmlFor="referencia">Tem em mente alguma referência ou elemento específico para fazer parte do logotipo?</label>
            <textarea required name="Tem em mente alguma referência ou elemento específico para fazer parte do logotipo?" className="place-text areaBriefing" id="referencia"></textarea>
          </div>

          <div className="form-briefing">
            <label htmlFor="elemento">Existe algum elemento que você não gostaria que estivesse presente na criação?</label>
            <textarea required name="Existe algum elemento que você não gostaria que estivesse presente na criação?" className="place-text areaBriefing" id="elemento"></textarea>
          </div>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="Possui alguma preferência de cor? Se sim, qual(is)?
" className="place-text areaBriefing" id="cores"></textarea>
          ...
          <div className="form-briefing">
            ...
            <textarea required name="Quais adjetivos você gostaria que melhor descrevessem sua futura marca?" className="place-text areaBriefing" id="adjetivos"></textarea>
          </div>

          <div className="form-briefing">
            <label htmlFor="concorrentes">Cite pelo menos 3 concorrentes seus e diga o que você acha sobre o logotipo que possuem.</label>
            <textarea required name="Cite pelo menos 3 concorrentes seus e diga o que você acha sobre o logotipo que possuem." className="place-text areaBriefing" id="concorrentes"></textarea>
          </div>
